    ...
    public static void merge() {
        ...
        if (swaggerCount > 0) {
            ...
            for (int i = 1; i < swaggerCount; i++) {
                Swagger temp = new SwaggerParser().read(Constants.INPUT_PATH + File.separator + i + ".json");
            ...
            try {
                ...
                FileWriter writer = new FileWriter(Constants.OUTPUT_PATH + File.separator + "swagger.json");
                writer.write(json);
                writer.close();
